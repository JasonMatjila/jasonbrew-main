  ...
  >
    ...
    >
      <p class="mb-2 text-white">
        Copyright &copy;
        <a class="font-weight-bold capitalize" href="/">JASON BREW CAFÉ LTD PTY</a>
        All Rights Reserved.
      </p>
      <p class="m-0 text-white">
        Designed by
        <a class="font-weight-bold" href="/">JasonMtjila</a>
      </p>
    </div>
  </div>
  <!-- Footer End -->
...
.offer,
.footer {
  background: linear-gradient(rgba(51 33 29 / 55%), #120c0b), url("/images/footerbg.jpg");
